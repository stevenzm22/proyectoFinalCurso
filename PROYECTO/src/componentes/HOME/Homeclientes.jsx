...
function Homeclientes() {
  return (
    <div>
        ...
        <div className="contenedorImagen" id="imagen1"></div>
        <div className="contenedorImagen" id="imagen2"></div>
        <div id="contenedorTexto">
            <h3>¿Por qué crear un evento?</h3>
            <p>Organizar eventos es una excelente manera de conectar con la comunidad...</p>
        
        </div>
        <div className="contenedorImagen" id="imagen3"></div>
        <div className="contenedorImagen" id="imagen4"></div>
